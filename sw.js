const CACHE='khalid-saqr-canonical-v1';
const ASSETS=['./','index.html','assets/css/main.css','assets/js/app.js','llms.txt','data/profile.json','data/person.schema.json','data/facts.json','data/publications.json'];
